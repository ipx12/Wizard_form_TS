...
export interface IUser extends IAccauntFormValues, IProfileFormValues, IContactsFormValue, ICapabilitiesFromValue{
}

export type AllFormsType = IAccauntFormValues | IProfileFormValues | IContactsFormValue | IAccauntFormValues
